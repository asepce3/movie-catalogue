...
class MovieRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(localData: LocalDataSource, remoteData: RemoteDataSource, appExecutors: AppExecutors): MovieRepository =
            instance ?: synchronized(this) {
                instance ?: MovieRepository(localData, remoteData, appExecutors).apply { instance = this }
            }
    }
